...
public class JaxbSample {
	...
	public static void objectToXml() throws Exception {
		...
		FileWriter writer = new FileWriter("D:\\workspace\\spring3Demo\\src\\main\\java\\com\\migutv\\oxm\\xml\\JaxbSample.xml");
	...
	public static User  xmlToObject() throws Exception {
		JAXBContext context = JAXBContext.newInstance(User.class);
		FileReader reader = new FileReader("D:\\workspace\\spring3Demo\\src\\main\\java\\com\\migutv\\oxm\\xml\\JaxbSample.xml");
